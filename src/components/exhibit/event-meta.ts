...
const META: Record<string, EventMeta> = {
  ...
  "doc.read": { accent: "text-violet-600", tag: "DOKUMEN" },
  "voice.transcribed": { accent: "text-violet-600", tag: "SUARA" },
...
const STEP_META: Record<string, StepMeta> = {
  ...
  "doc.read": { icon: "📄", title: "Membaca dokumen" },
  "voice.transcribed": { icon: "🎙️", title: "Mendengar pesan suara" },
